...
function searchBookByName() {
	...
	$.ajax({
		url : '/inventoryService/books/googlebooks/' + bookName,
		type : 'GET',
...
function showSearchResult(values) {
	...
	tr.cells[4].appendChild(document.createTextNode('Quantity Available in Inventory'));
